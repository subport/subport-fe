...
interface AddSubscriptionSelectableCardProps {
...
function AddSubscriptionSelectableCard({
  subscription,
  selectedSubscription,
  isSelected,
}: AddSubscriptionSelectableCardProps) {
...
export default AddSubscriptionSelectableCard;
